...
async def fetch_data_for(symbol: str) -> dict:
    ...
    url = f"https://priceapi.moneycontrol.com/techCharts/indianMarket/stock/history?symbol={symbol}&resolution=1D&from=1471478400&to=1710115200&countback=1973&currencyCode=INR"
    print("url : ",url)
    def sync_call():
